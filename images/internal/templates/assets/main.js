...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Handle checkout button loading states
    document.querySelectorAll('.pricing-button[hx-post="/checkout"]').forEach(button => {
        ...
        button.addEventListener('htmx:afterRequest', (event) => {
            ...
            // It will be removed when page navigates away
