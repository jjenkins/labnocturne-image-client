...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = 'https://github.com/jjenkins/agent-image-skills'
  spec.license       = 'MIT'
  spec.required_ruby_version = '>= 2.7.0'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/jjenkins/agent-image-skills/tree/main/ruby'
  spec.metadata['bug_tracker_uri'] = 'https://github.com/jjenkins/agent-image-skills/issues'
