...
Usage:
  ./flex migrate
  ./flex migrate up      (default, applies all pending migrations)
  ./flex migrate down    (rolls back the most recent migration)
  ./flex migrate version (displays the current migration version)`,
